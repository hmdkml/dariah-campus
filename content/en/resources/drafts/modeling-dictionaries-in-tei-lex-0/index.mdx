...
<Figure src="/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/5W4FYO0.jpg">
  Good news for people who love bad news. CC BY-ND Olivia Mew
</Figure>
...
7. Click on the downward pointing arrow next to `<teiHeader>` to fold the contents of the teiHeader.
   ...
   ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/4sChbKf.png)
...
8. Go back to your previously saved XML file and copy everything starting with `<entry>` and ending with `</grammar>`; in your current TEI file, delete `<p></p>` inside `<body></body>` and then paste the copied contents from the old file instead.
   ...
   ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/fUhNsam.png)
...
10. Hover with your mouse over the underlined end tag `</body>` to see what error oXygen will report there.
    ...
    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/OavdVsI.png)
...
12. Now, double-click the element name in `<lemma>`.
    ...
    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/mF7Z2eG.png)

13. Change the element name to `<form>`.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/2qrKjU9.png)

14. Select `@normalized` and its value, then delete both.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/lFxOuUv.png)

15. Add attribute `@type` to `<form>` and check out what options are suggested for values.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/Mkja90a.png)
...
17. Select the text value of `<form>`.
    ...
    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/rxDpq2B.png)
...
18. Control-click or right-click the selected word to bring up a contextual menu, then select Refactoring › Surround with Tags.
    ...
    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/sznObNh.png)
...
19. Select orth from the dropdown by scrolling to it, or for a more efficient solution, start typing `o` in the field "Specify the tag".
    ...
    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/OmnlATZ.png)

20. Add `@norm` to `<orth>`.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/G0WXZJt.png)

21. Type in 'lexicographer' as value of `@norm`.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/QVLcDwe.png)

22. Remember the "Fromat and Indent" icon that we introduced in the last unit? Find it and click on it.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/U8jiQxe.png)

23. Finally, replace `<grammar>n.s.</grammar>` with `<gramGrp><pos>n.s.</pos></gramGrp>`.

    ![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/arlT3FD.png)
...
![](/assets/content/en/resources/drafts/modeling-dictionaries-in-tei-lex-0/Feuy9gD.png)
