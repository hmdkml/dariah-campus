...
summary:
  content: This learning resource provides software developers and computational
    linguists with an overview of the typical computational processing tasks
    and software tools in the lexicographic workflow. The resource introduces
    the most widely used custom developed tools for corpus-based lexicography as
...
A separate module of the ELEXIS Curriculumgives an overview of the [CLARIN Tools and Resources for Lexicographic Work](/id/UnwYPq70Dewbn7XDEjsMM).
