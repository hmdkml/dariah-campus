...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-input-01.png)

Now, type `//entry` into the XPath input field and press return on your keyboard.

You should be seeing something like this:

![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-input-02.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-builder-01.png)

Once you launch the XPath Builder View, you should be seeing something like this:

![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-builder-02.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-builder-03.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-nodes-01.png)

| Expression    | Selects                                  |
| ------------- | ---------------------------------------- |
| `//form/orth` | all orth nodes that are children of form |

![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-nodes-02.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-nodes-03.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-exercise-01.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-axes-01.png)
...
![](/assets/content/en/resources/hosted/xpath-for-dictionary-nerds/oxygen-axes-02.png)
