...
locale: en
publicationDate: 2022-04-25T09:14:43.829Z
version: 1.0.1
authors:
  - klee-anne
editors:
...
![Upload](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/upload.svg)
...
![Configuration](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/configuration.svg)
...
![Publication](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publication.svg)
...
![Register](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/register.svg)
...
![Login](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/login.svg)

If you already have a user account, you can log in to the home page with your registered e-mail address and your password.

### Logout

![Logout](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/logout.svg)

Within Publex, you can log out of your profile at any time using the logout icon in the top menu bar.

### Forgot your password?

![Forgot password](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/password.svg)
...
![Profile](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/profile.svg)
...
![Import Komplett Font file](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr_studio_load_a_file.png)

![](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr_studio_import_all.png)
...
![](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr_studio_private_use_area.png)
...
![](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/glyphr_studio_zeichenansicht.png)
...
![u with superscripted plus (entity file)](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove.png)
...
![u with superscripted plus (xml)](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove_xml.png)

And this is how the character is finally displayed using the KomplettFont:

![u with superscripted plus (displayed)](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/uplusabove_wbnetz.png)
...
![Welcome page Bitbucket](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/home_bitbucket.png)

![Create new repository](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new_repo.png)
...
![New repository](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new_repo.png)
...
![Copy clone command](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone_command.png)
...
![Dictionary Overview](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/dictionary_overview.png)

2. A new window opens. Type in the **name** of your new dictionary and optionally a description.

![Add new dictionary](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/new_dictionary.png)
...
1. There are two possible ways to get to the **import page**: a) You create a new dictionary and immediately go to the XML file import (see [here](#creating-a-new-dictionary)). b) In the Dictionary Overview, select a dictionary that has already been created and click on **"Edit Dictionary"**.
   ...
   ![Edit dictionary](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/edit_dictionary.png)

In the menu bar on the left, under **"Dictionary Management"**, select **"XML File Import"**.

![Left menu bar](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/left_menu.png)

2. Now you have to provide Publex with the information where to find your dictionary data.

![Define import](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/import_data.png)
...
![Clone Button](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone_button_bitbucket.png)

![Repo URL](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/clone_ssh.png)
...
1. If your repository is public, no further settings are necessary for the import. If it is a private repository, please mark the checkbox "This is a private Git repository!".
   ...
   ![Private Git](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/privategit.png)
...
![Personal settings](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bitbucket_personal-settings.png)
...
* In personal settings, go to "SSH keys" and click on "Add key". A Window opens where you can paste your key you copied from Publex.
  ...
  ![Add key](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add_key.png)
...
* ![Test\_Git](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/button_test_git.png)
...
![Delete dictionary](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete_dictionary.png)
...
![Lock a dictionary](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lock_dictionary.png)

![Locked dictionary](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/locked_dictionary.png)
...
![](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/edit_dictionary.png)

![Metadata Management](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/metadata_management.png)
...
![Dictionary Categories](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/metadata_categories.png)
...
* The order can be modified at any time using the arrow buttons.
  ...
  ![Change Order](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/arrows.png)

<Callout title="Advice for the choice of font" kind="tip">
...
![Add new sytyling rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add_new_rule.svg)
...
![Name rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/name_rule.png)
...
![Dropdown menu tags](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/tag_choice.png)

Now you have different options:

1. **You select only one element tag**. The rule then applies to all elements with this tag name, regardless of the attributes: ![Only tag](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/only_tag.png)
...
![add attribute](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add_attribute.png)

![attributes](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/attributes.png)
...
![add value](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/add_value.png)

![tag, attribute, value](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/attribute_values.png)

Attributes and attribute values that have already been selected can be removed with the minus symbol on the right.

![delete attribute](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete_attribute.png)

### Search and lemma field

For each rule, there are different options you can select in the settings:

![settings](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/settings.png)
...
![Styling functions I](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling_functions_1.png)

![Styling functions II](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling_functions_2.png)

Planned additional formatting functions:

![Styling functions II](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/styling_functions_3.png)

### Save and discard

When you have defined a new rule or made changes, save them with the save button at the top of the right.

![Save](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/save.png)

Single rules can be deleted via the bin button.

![Delete rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/delete_rule.png)
...
![Discard changes](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/discard_changes.png)
...
![Lock rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lock_rule.png)
...
![Export and Import Styling Rules](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/export_import.png)
...
![Import Styling Rules](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/import_config.png)

After clicking on "OK", the rules are imported and displayed.

<Callout title="Saving" kind="warning">
...
![Lexer bluome Foto](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome_categories.png)

This is how the XML annotated entry looks like:

![Lexer bluome XML](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome_xml.png)
...
![information types](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/information_types.png)

![typograhocal types](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/typo_types.png)
...
![entry rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/entry_rule.png)
...
![Defining lemma rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lemma_rule.png)
...
![Defining grammar rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/grammar_rule.png)

#### Definition

The text contained in `<def>` should also be set in italics. We additionally activate the checkbox "Set as searchable field".

![Defining definition rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/def_rule.png)

#### Citation

Quoted examples are coded with `<cit type="example">` and should be displayed in green.

![Defining citation rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/citation_rule.png)
...
![Defining author rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/author_rule.png)
...
![Defining italics rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/superscript_rule.png)

![Defining recte rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/recte_rule.png)

![Defining superscript rule](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/superscript_rule.png)
...
![Preview entry bluome](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/bluome_preview.png)
...
![Preview Website Left Menu](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/left_menu_preview.png)

Or by going to your dictionary in the Dictionary Overview and click on "Preview Website":

![Preview Website Overview](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/preview_website.png)

A new tab opens in the browser with the preview:

![Dictionary Viewer](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/dictionary_viewer.png)
...
![Search lemma list](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/lemmalist_search.png)

### The dictionary look-up

In the dictionary look-up the user has the choice between a general fulltext search

![simple search](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/simple_search.png)

and an advanced search.

![advanced search](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/advanced_search.png)
...
![Search result](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/search_result2.png)
...
![Publication](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publication_button.png)
...
![Publex Button](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/publex_button.png)
...
![Published Dictionaries](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/published_dictionaries.png)
...
![Reverse a publication](/assets/content/en/resources/hosted/how-to-publish-your-dictionary-data-with-publex/unpublish_button.png)
