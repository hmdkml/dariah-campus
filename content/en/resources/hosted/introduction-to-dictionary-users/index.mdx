...
locale: en
publicationDate: 2022-01-02T10:19:21.566Z
version: 1.0.0
authors:
  - kosem-iztok
  - wissik-tanja
...
As we already learned in the [Introduction to Dictionaries](/resources/hosted/introduction-to-dictionaries),
...
then have an effect on dictionary [macrostructure](/resources/hosted/introduction-to-dictionaries) and
[microstructure](/resources/hosted/introduction-to-dictionaries), for example on the amount of
...
There are many [criteria](/resources/hosted/introduction-to-dictionaries) that can be used to
...
![](/assets/content/en/resources/hosted/introduction-to-dictionary-users/overall-dissimilarity-sl-eu.png "Figure 2: Overall dissimilarity Slowenian and EU dictionary users")
...
![](/assets/content/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-europe.png "Figure 3")

![](/assets/content/en/resources/hosted/introduction-to-dictionary-users/esd-plot-2022-05-12-north-macedonia.png)
...
![](/assets/content/en/resources/hosted/introduction-to-dictionary-users/table-1-overview.png "Table 1")
