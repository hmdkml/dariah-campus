...
locale: en
publicationDate: 2022-01-01T05:20:50.667Z
version: 1.0.0
authors:
  - tiberius-carole
  - munda-tina
...
If you already want to read more about the ELEXIS Data Model, see [Towards the ELEXIS data model: defining a common vocabulary for lexicographic resources](https://elex.link/elex2021/wp-content/uploads/2021/08/eLex\_2021\_03\_pp56-77.pdf) and the ongoing work on [LEXIDMA](https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=lexidma).
...
![](https://lh5.googleusercontent.com/oqXnBUD-dywul9jPV_qJdEGzJup9xh_QnZzmankQ-MtyKygDmgRqOI77gVScBhTp7Spy-lgF7Qm91qvf9IgjawuZKfX0WRcRgwu1-ZJInMJNZpQ0nG9RFZGGudFXcXSnm\_8mawNUMbLNxnwEfw)
...
![](https://lh5.googleusercontent.com/XR20CqpMPy8Lm1uIrbp8T-so3cJHiCo0B8b1W2wpt4pEDcSyy4HBUZXMWHYiKHzX3cDB9I0\_TGAVIzgAvncUrQbRlXRzTohec9RjzqNLHm01pe3RRVGI1rA2SOF66SKuFCFVmuwu5-noc8bsAg)
...
Transforming the Part of Speech tag is a little more difficult in our Sample Dictionary as the part of speech value is stored in an attribute of the PartOfSpeech tag.![](https://lh5.googleusercontent.com/l38pQRWaZzn7jatj0JommeX-R2b7CCw8EV24X2WZuc97HJbVDBlpolJHnZQdKLpMj_Nn-9nav\_0RE4dRrP9QqaXoUOwuGpxq2Gu_KP0eV_shMTEVzcE_p5qJ-X5Mei_Op3ndBs5C9WGOKgzGkg)To transform the Part of Speech, you first need to specify the tag name, i.e. PartOfSpeech and then you need to select the value of the attribute. You do this by selecting the option ‘attribute value’ from the dropdown menu.
...
![](https://lh6.googleusercontent.com/FPWb2IwsQhgw_rT_ATYop2sF4bsLuRBSigQqJeIxPFjAZV4tk-lIHNfm5WRGyYVGhrRCdbj7zhIqGIu\_3Qovbl9z4388nE9DwVL7NmBM04\_5s4QZw3aIOY8\_c5j-PHHc3rz1P7KDTuOiAYhWiA)
...
![](https://lh4.googleusercontent.com/fDnPBjLk-PFPA8HjdlAWy0238UquJe3EyJNyGxTPsGxyDQf9cD7QAXrM\_20OIgGM1OvwM5QeZkoVFa2iH5TkogfumwBR6o23u7AytEQiMcUF_TdbPNXqLPhLDjRVyzaZ71ltld7sEhHlAQrkZA)
...
![](https://lh6.googleusercontent.com/b_iSR49-3m6O1-93uOu8Sm60Pu9X64lVVQjy86\_sLIQQ55ZJxRV-k7I7yYR5yvZKw_x71cr70NpZD-ZBsBVOFhM-XT3TPEuDFrrSvONyd8pKN4jnJ6K9WGgCcdceLc9jG4yW2SOcJhyVpDwGfg)

You can then choose to download with or without namespaces. 

![](https://lh5.googleusercontent.com/kXw1mzanyCUjTsLey1S5Ohf6ObTY2g8y4apo_MKokDlh3WR_vnvYLzZ4GnHMU6JCVf3ccAayF7hikfm-Q7pBEo_uszCAtk3tjSpcp7M2-Hl4V094k3IZ3rKkJqt8\_MXWMOkqN5pP_t7mYch\_-Q)
...
Lexonomy is a cloud-based, open-source platform for writing and publishing dictionaries. In the course [Lexonomy: Mastering the ELEXIS Dictionary Writing System](/id/Qm\_2SzS_rGB-Py9YTCHYm) you learn how to use Lexonomy.

You may be also interested in checking out [Deliverable 1.4 ELEXIS Conversion Tools](https://elex.is/wp-content/uploads/2021/05/ELEXIS_D1\_4\_ELEXIS_Conversion_Tools.pdf) The appendix of this deliverable contains examples from dictionaries from ELEXIS partners, showing the input format together with the transformed output from Elexifier.
