...
![Graphic guide to the ELEXIS Dictionary Tools](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/elexis_dictionary_tools.png "Graphic guide to the ELEXIS Dictionary Tools")
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-0.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-1.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-2.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-3.png)

The transformation already contains three elements, i.e. entry, headword and sense.

![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-4.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-5.png)

![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-6.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-7.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-8.png)

So far so good. Let's now look at "PART OF SPEECH".

Transforming the Part of Speech tag is a little more difficult in our Sample Dictionary as the part of speech value is stored in an attribute of the PartOfSpeech tag.![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-9.png)To transform the Part of Speech, you first need to specify the tag name, i.e. PartOfSpeech and then you need to select the value of the attribute. You do this by selecting the option 'attribute value' from the dropdown menu.

![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-10.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-11.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-12.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-13.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-14.png)

You then set the path to the example translation element.

![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-15.png)
...
![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-16.png)

You can then choose to download with or without namespaces.

![](/assets/content/en/resources/hosted/lex3-transforming-legacy-dictionaries-using-elexifier/image-17.png)
