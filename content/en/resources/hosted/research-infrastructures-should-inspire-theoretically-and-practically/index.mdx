...
<VideoCard title="Research Infrastructures Should Inspire, Theoretically and Practically" id="GIw3VHJwu5Y" image="images/agiatis-training.png" provider="youtube" />
