...
At the end of the course, students will be familiar with the principles and procedures involved in writing, editing, or compiling dictionaries, considering standards in different parts of their lexicographic workflows.<Footnote>For more information, see D1.2 Best practices for lexicography – intermediate report, 31.01.2020 (Tiberius et al., 2020).</Footnote>
...
[ISO/TC37 'Language and terminology'](https://www.iso.org/sites/outage/) plays a key role in enabling language for computing environments. It creates standards for structuring language resources. 'Structurable' language resources include terminologies, lexical resources (dictionaries, lexicons, etc.), language-based commercial data (names, properties, catalogues, etc., of products and services), signs and symbols, codes and formulae, corpora (text, speech, audio), taxonomies and ontologies.

According to the ISO, ['A standard is a document that provides requirements, specifications, guidelines or characteristics that can be used consistently to ensure that materials, products, processes and services are fit for their purpose'](https://www.iso.org/standards.html). Standards are seen as ['a formula that describes the best way of doing something'](https://www.iso.org/standards.html). Concerning lexicography, standards provide a common vocabulary, establish specifications and procedures to guarantee the material's reliability and interoperability and to facilitate the representation of lexicographic data. Formats (ex. TEI) are in these contexts schemas to represent structured data and models (ex. OntoLex Lemon) are abstractions of structured systems.
...
[**ISO**](https://www.iso.org/home.html) is an international non-governmental organisation composed of several national standardisation bodies that develop and publish a wide range of standards. The international standards are the result of the work carried out through ISO Technical Committees, generally compounded by specialists and governmental and non-governmental international organisations.

International standards related to lexicography are the ones developed by the TC 37, 'Language and terminology', namely the [Subcommittee 2 (SC2)](https://www.iso.org/committee/48124.html) and [Subcommittee 4 (SC4)](https://www.iso.org/committee/297592.html), 'Language and resource management'. ISO 1951 (2007) is an ISO TC37, SC2 standard that 'specifies a formal generic structure independent of the publishing media and it proposes means of presenting entries in print and electronic dictionaries' (ISO 1951, 2007, p. 1). The purpose of the standard is "to facilitate the production, merging, comparison, extraction, exchange, dissemination and retrieval of lexicographical data in dictionaries" (*ibidem*). The standard, right under a revision process, starting in 2022.
...
[**OntoLex-Lemon**](https://www.w3.org/2016/05/ontolex/) is a 'vocabulary for publishing lexical data as a knowledge graph, in an RDF format and/or as Linguistic Linked Open Data' developed by the [W3C Ontology-Lexica Community Group](https://www.w3.org/community/ontolex/) (Cimiano, McCrae, & Buitelaar, 2016) based particular particularly on a Ontology Web Language – OWL (McGuinness & van Harmelen, 2004) and the Lexicon Model for Ontologies, also known as lemon model (McCrae et al., 2012).

OntoLex-Lemon has become widely known for the representation of lexical data on the semantic web, including Princeton WordNet and FrameNet, and has gradually acquired the status of a [*de facto* standard](https://en.wikipedia.org/wiki/Knowledge_graph;https://www.w3.org/community/ontolex/). Concerning the conversion of lexicographic resources into [linked open data (LOD)](https://www.w3.org/standards/semanticweb/data#summary), this model is the preferred choice of many researchers (Klimek & Brümmer, 2015; Declerck et al., 2019; Abromeit et al., 2016; Bosque-Gil et al., 2016; McCrae et al., 2019).

OntoLex-Lemon modelling is based on [RDF triplets](https://www.w3.org/RDF/): subject, predicate and object. The (ISO 24613-1, 2019) Lexical Markup Framework (LMF) standard also played an important role in defining OntoLex-Lemon – the LMF directly inspired this module in defining lexical entries as the core element of the lexicon. Trying to overcome some OntoLex-Lemon limitations when modelling lexicographic information as linked data, the OntoLex community developed the lexicography module (lexicog), a model to encode existing dictionaries as Linguistic Linked Open Data. This module operates in combination with the OntoLex core module. Nevertheless, Lexicog is not a W3C Standard, nor is it on the W3C Standards Track, the reason why, we are going to stick to the OntoLex core module.
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/dic_structure.png "Figure 1: Model of a Dictionary Structure (Salgado, 2021)")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-2.png "Figure 2")

#### 1.2 lexicographic article

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexicographic-article.png "Figure 3")

#### 1.3 dictionary structure

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/1.3.png "Figure 4")

#### 1.4 macrostructure

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-5.png "Figure 5")

#### 1.5 microstructure

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-6.png "Figure 6")

#### 1.6 mediostructure

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-7.png "Figure 7")

#### 1.7 lexicon

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-8.png "Figure 8")

#### 1.8 lexical unit

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexical-unit.png "Figure 9")

#### 1.9 lexicographic component

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-10.png "Figure 10")

#### 1.10 headword

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/1.9.png "Figure 11")

#### 1.11 sense

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-12.png "Figure 12")

#### 1.12 part of speech

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-13.png "Figure 13")

#### 1.13 canonical form

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-14.png "Figure 14")

#### 1.14 lemma

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-15.png "Figure 15")

#### 1.15 sense component

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-16.png "Figure 16")

#### 1.16 lexicographic definition

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexicographic-definition.png "Figure 17")

#### 1.17 label

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-18.png "Figure 17")

#### 1.18 example

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/example.png "Figure 18")

#### 1.19 note

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/figure-19.png "Figure 19")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/minimal_structure.png "Figure 20: XML representation of minimal microstructure of a monolingual lexicographic article")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly.drawio.png "English lexicographic article. Retrieved from: Oxford English Dictionary, https://www.oed.com (07/01/2022)")

#### 2.2 French lexicographic article: mouche

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/mouche.drawio.png "French lexicographic article. Retrieved from: Le Robert, https://dictionnaire.lerobert.com/definition/mouche (07/01/2022)")

#### 2.3 Portuguese lexicographic article: mosca

![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/mosca.drawio.png "Portuguese lexicographic article. Retrieved from:  Dicionário da Língua Portuguesa Contemporânea, Academia das Ciências de Lisboa (2001)")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly_ontolex.png "Representation following Turtle code")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly_tei.png "TEI Lex-0 encoded lexicographic article")
...
![](/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/fly_lmf.png "LMF encoded lexicographic article")
...
<Figure src="/assets/content/en/resources/hosted/standards-for-representing-lexicographic-data-an-overview/lexml_18_07_22.png" alt="LexModel" />
