...
<VideoCard title="Click to view" id="DUlfC8NL0Bs" image="/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_and_skos_title_image.jpg" provider="youtube" />
...
Patricia Harpring<Footnote>Harpring, Patricia. Introduction to controlled vocabularies: terminology for art, architecture, and other cultural works. Getty Publications, 2010.</Footnote> introduced the following definition of controlled vocabulary (CV):
...
![Diagram 1. Controlled vocabularies in data architecture](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_and_skos_model_diagram_1.png)
...
Tim Berners-Lee in his fundamental paper "The Semantic Web" (2001) says that on the Semantic Web "information is given well-defined meaning"<Footnote>Berners-Lee, Tim, James Hendler, and Ora Lassila. "The semantic web." Scientific american 284, no. 5 (2001): 28-37.</Footnote>. CVs are one of the tools used for this mission.
...
![Diagram 2. Usage of a common controlled vocabulary for data description in different projects](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/diagram_2.jpg)
...
![Diagram 3. Interoperable controlled vocabularies](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/diagram_3.jpg)

There are also meta-vocabularies developed with a primary goal to be a high-level overarching vocabulary for more domain-specific CVs. Therefore making it easier to connect local CVs and establish relationships among them through common meta-level concepts. [Backbone Thesaurus](https://www.backbonethesaurus.eu/) is one of the examples in the DH domain that has as its purpose to allow interdisciplinary CVs development and integration.

![BBT - Backbone Thesaurus in Vocabs repository](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/bbt.png)

## SKOS Standard

### About SKOS

[SKOS](https://www.w3.org/TR/skos-reference/) is a Simple Knowledge Organization System, a common data model for sharing and linking knowledge organization systems via the Web.
...
Picture 1. Visualization of [IAD Thesaurus](https://vocabs.acdh.oeaw.ac.at/iad_thesaurus/en/)

![Picture 1. Visualization of IAD thesaurus](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/iad_thesaurus_visualization.png)
...
![Picture 2. Controlled vocabularies in IAD curation interface](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_in_curation_interface.png)
...
![Picture 3. Pop up with a vocabulary term definition and traslations in user interface](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_popup_in_userinterface.png)

* Faceted search is based on CVs: dropdowns and autocompletes

Picture 4. CV in faceted search interface

![Picture 4. Controlled vocabularies in IAD search interface](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_in_search_interface_01.png)

Picture 5. CV in faceted search interface

![Picture 5. Controlled vocabularies in IAD search interface](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/cv_in_search_interface_02.png)
...
![Picture 6. IAD - Iron-Age-Danube Thesaurus in Vocabs repository](/assets/content/en/resources/hosted/controlled-vocabularies-and-skos/vocabs_iad.jpg)
