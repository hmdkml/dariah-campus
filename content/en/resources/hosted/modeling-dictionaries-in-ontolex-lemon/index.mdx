...
locale: en
publicationDate: 2022-01-02T13:29:45.624Z
version: 1.0.0
authors:
  - mccrae-john
  - khan-fahad
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/introduction-to-the-ontolex-lemon-model.png "Timeline of the development of the OntoLex-Lemon model")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/edema_messy.png "Modelling links between knowledge graphs and lexical resources can lead to many links between the concepts")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/introduction-to-the-ontolex-lemon-model-2-.png "Modelling with lexical entries")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/introduction-to-the-ontolex-lemon-model-3-.png "Named forms allow for grammatical properties such as plural to be represented")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/introduction-to-the-ontolex-lemon-model-4-.png "Lexical sense are named elements that describe the usage of a particular word with a particular meaning")

## The OntoLex-lemon Model

### The core model

![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/lemon_ontolex_core.png "The OntoLex-lemon core model")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/lemon_syntax_and_semantics.png "The synsem module")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/lemon_decomposition.png "The decomposition module")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/lemon_variation_and_translation.png)
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/introduction-to-the-ontolex-lemon-model-5-.png "Translation modelling in OntoLex-lemon")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/lemon_lime_metadata.png "The LiME model")
...
![](/assets/content/en/resources/hosted/modeling-dictionaries-in-ontolex-lemon/ontolex-lexicography-module_v.5.png "The lexicography module")
