...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/GryLeOV.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/0OdwZBl.png)
...
<Callout title="What's where?" kind="note">
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/rOUKxhU.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/kCvAgiV.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/HB10n6A.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/H8wQgZD.png)
...
3. Start typing `form` inside the menu.
   ...
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/1kNKpZK.png)
...
4. Once you see the `form` element selected in the dropdown, click the OK button. This will wrapp the selected word with `<form></form>`.
   ...
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/GSl6uCJ.png)

5. Since `Lexico'grapher` is still selected, you can press `Command + E`/`Ctrl + E` again and choose `orth` from the dropdown.

   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/Od6XM2D.png)

   This will wrap the content in the `orth` element inside the `form` element.
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/tEkrSQs.png)

<Callout title="Takeaway" kind="note">
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/RYEZGnV.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/7tcWKzu.png)

<Callout title="Takeaways" kind="note">
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/383sMoY.png)
...
1. Open the `dictionary.xml` file, in case you don't already have it open. You will most likely see something like this:
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/lYrtO9L.png)
2. Remove the manually created `<form></form>` and `<orth></orth>` tags. Ideally, you should do this by clicking within the word "Lexicographer" and then using the default "Delete element" shortcut that we introduced above. You should then reuse the same shortcut to get rid of the `<form></form>` tags. If you don't remember the shortcut, you can look it up above -- or inside your oXygen preference. You should then be seeing this:
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/XvNbPVB.png)
3. Now, select the word "Lexicographer" and press `Command` + `Space` (on macOS) / `Ctrl` + `Space` (on Windows) to retrieve a content completion list. You should get a list of your custom code templates. Since we have only just created one, you should be seeing this:
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/Y3Zi7Bb.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/RIM5Znb.png)

### Grid Mode

When you switch to Grid Mode, your sample entry should now look like this:

![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/WD0hYwo.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/gWxF8HD.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/mHsfDbd.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/CfiVo8e.png)
...
![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/HszAmZV.png)
...
<Callout title="Frameworks in oXygen" kind="note">
...
4. Click on the icon with a green arrow and select `${pd} - Project directory` from the dropdown. Add `/frameworks` to the input field. This will tell oXygen to look for framework definitions inside the frameworks folder inside the project directory. Click OK.
   ![](/assets/content/en/resources/hosted/mastering-oxygen-xml-editor-for-dictionary-nerds/IAXgEGO.png)
5. Click Apply.
