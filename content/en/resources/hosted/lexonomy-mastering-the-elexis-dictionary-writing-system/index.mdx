...
- _Expert settings_: entry editor, setting up flags and auto-numbering, linking entries, creating subentries, as well as as establishing the connection between Lexonomy and Sketch Engine and KonText. 
