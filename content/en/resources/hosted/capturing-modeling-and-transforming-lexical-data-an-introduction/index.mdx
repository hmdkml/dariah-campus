...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/NNw9TI3l.jpg">
  CC-BY-SA-3.0 [E.Herzel](https://commons.wikimedia.org/wiki/File%3ABrand_Anna_Amalia_22.30Uhr.JPG)
</Figure>
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/a18wpcc.png">
  Print Dictionary to Machine Readable Text
</Figure>
...
Depending on the overall purpose of a project, optimization may include the following:<Footnote>See Image Optimisation. An IMPACT Briefing paper.</Footnote>
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/gL9q7IR.png">
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/vwNwE7m.png)
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/ibLRh2V.png">
  Example 1. Linde Dictionary: decent OCR by the ABBYY Cloud OCR service.
</Figure>

**Czech-Polish Dictionary**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/ZiR7oXj.png">
  Example 2. Czech-Polish dictionary: here also the OCR result is quite decent.
</Figure>

**Rechnik malyj**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/r8OsT9C.png">
  Example 3. Rechnik Malyj: the German OCR works a bit, the (old style) Cyrillic is useless.
</Figure>

**Mikloshich**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/i7e5KJd.png">
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/mMpTAsW.png">
  Example 5. Serbian Etymological Dictionary: The OCR of modern Cyrillic is of acceptable quality
</Figure>

**Grimm**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/LcgMewV.png">
  Example 6. Grimm: OCR is reasonable, but could have been better with a higher resolution image.
</Figure>

**Bernolak**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/a2cySIK.png">
  Example 7. The Bernolak dictionary: rather bad OCR.
</Figure>

**Warsaw Dictionary**

<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/w8vBdD4.png">
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/m7KgRCc.png">
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/VrVwmXY.jpg">
...
<Figure src="/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/Kz6BAM8m.jpg">
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/BgYAA8o.jpg)
...
<Video provider="youtube" id="MwT4GB-AXbQ" />

#### Marked-up vs. plain text
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/fCtF2ut.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/0pHEzSi.jpg)
...
\section{Marked-up vs. plain text}
\end{document}
```
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/s1iiWwE.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/pSfhfx4.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/boxes.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/folders.png)
...
2. Select File > New and make the contents of the New Document folder visible by clicking on it. Alternatively, type in "xml" in search field.
   ...
   ![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/le073Bh.png)

3. Select "XML Document". Doing this should open up a blank document with an XML declaration `<?xml version="1.0" encoding="UTF-8"?>` added. One thing you will notice, however, is a red marker in the right margin of your document, and an error message at the bottom reading "A well-formed document requires a root element." ![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/wDefnSg.png)
   ...
   Once you do add the above, the error about your file being not well-formed will dissappear, the red marker in right margin will turn to green, and oXygen will purr with happiness. Ok, the last bit won't happen, but oXygen will keep track of your XML file all the time, letting you know when things go frong. ![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/PX0zBGq.png)
...
1. Click on the "Fromat and indent" icon or select Document > Source > Format and indent. ![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/OQbSxd2.png)
2. As a result, your XML will be reformatted for your viewing pleasure. ![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/0nTpO6N.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/4sChbKf.png)
...
![](/assets/content/en/resources/hosted/capturing-modeling-and-transforming-lexical-data-an-introduction/OavdVsI.png)
