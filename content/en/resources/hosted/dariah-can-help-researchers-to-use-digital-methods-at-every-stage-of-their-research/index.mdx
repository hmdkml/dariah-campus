...
<VideoCard title="DARIAH can help researchers to use digital methods at every stage of their research" id="RnGyt4uymv8" image="images/paavolainen-training.png" provider="youtube" />
